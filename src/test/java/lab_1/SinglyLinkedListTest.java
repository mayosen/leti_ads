...
public class SinglyLinkedListTest {
    ...
    public void generateSampleList() {
        sampleList = new SinglyLinkedList<>(new Integer[]{10, 5, 0, 888});
    }
    ...
    public void createFromArray() {
        List<Integer> list = new SinglyLinkedList<>(new Integer[]{10, 15, 20});
        assertFalse(list.isEmpty());
    ...
    @Test
    public void clearListWithSingleElement() {
        List<Integer> list = new SinglyLinkedList<>();
        list.add(12);
        list.clear();
        assertEquals(0, list.size());
